...
class Star(StarBase):
    ...
    def model(self, params: dict) -> dict:
        ...
        determs["log_Dnu"] = log_dnu = outputs[3]
        ...
        determs["Dnu"] = 10**log_dnu
        determs["log_numax"] = self.log_numax_sun + log_g - self.log_g_sun - 0.5 * (log_teff - self.log_teff_sun)
        determs["numax"] = 10**determs["log_numax"]
        ...
        # determs["mag"] = abs_mag - 5 * (1 + jnp.log10(0.005))
